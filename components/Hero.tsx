  ...
  return (
    <div id="hero" className="flex flex-col items-center justify-center h-screen bg-gray-50">
      ...
      <div className="mt-4 flex flex-col items-center space-y-4">
        <a href="./assets/cv.pdf" target="_blank" className="bg-white text-blue-500 px-4 py-2 rounded shadow hover:bg-gray-200 transition">Baixar CV</a>
      </div>
      <footer className="mt-4 flex space-x-4">
        <a href="https://github.com/romulogurgeldev" className="text-gray-500 hover:underline flex items-center">
          <FontAwesomeIcon icon={faGithub} className="w-6 h-6" />
        </a>
        <a href="https://www.linkedin.com/in/romulo-gurgel" className="text-gray-500 hover:underline flex items-center">
